...
Module ModuleGeneral_DA
    Public Const codigoProyecto As String = "778" ' variable que almacenara el numero de la campaña se ocupara para los procedimientos para reemplazar el numero de la campaña
